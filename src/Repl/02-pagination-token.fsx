...
//
// Run: dotnet fsi 02-pagination-token.fsx [--dapr-endpoint http://localhost:3500]
...
let paginateAllRecordings = task {
    ...
    while not isComplete do
        ...
        |}
        let! statusCode, body = postQueryAsync $"/v1.0-alpha1/state/{storeName}/query" (Json.serialize queryBody)
...
task { do! seedRecordings; do! paginateAllRecordings } |> _.Wait()
